...
▐░░░░░░░░░░░░░░░░▌▐░░░░░░░░░░░░░░░░▌▐░░░░░░░░░░░░░░░░▌▐░░░░░░░░░░░░░░░░▌
                    ...
                    1 Card Wizard Advanced Version
...
card1 = [836, 488, 62, 99] # Fill Me Out
card2 = [914, 486, 58, 99] # Fill Me Out
card3 = [991, 487, 63, 102] # Fill Me Out
card4 = [1069, 489, 62, 98] # Fill Me Out
card5 = [1148, 490, 58, 94] # Fill Me Out
card6 = [1223, 487, 62, 100] # Fill Me Out
card7 = [1302, 489, 60, 95] # Fill Me Out
...
potionsImageCenter = ''
spellbookImageCenter = image_Center(spellbookImage)
...
""") 
        ...
        while True:
            if passImageCenter == "" or passImageCenter == False:
                ...
                print(f"""{time.asctime()}
Collecting {passImage} coordinates, this will only occur once.
(Get in a battle if you aren't already)
""")
                time.sleep(5)
            else:
                break
...
""") 
        ...
        pyautogui.keyUp("a")
        time.sleep(.01)
        if pyautogui.locateOnScreen(noManaImage, confidence=.90) != None:
            while True:
